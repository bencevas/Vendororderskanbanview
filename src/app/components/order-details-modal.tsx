      ...
      <div className="bg-white dark:bg-gray-800 rounded-t-xl min-[481px]:rounded-lg shadow-xl w-full min-[481px]:max-w-3xl h-[95vh] min-[481px]:h-auto min-[481px]:max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600 px-4 min-[481px]:px-6 py-3 min-[481px]:py-4">
          ...
          <div className="flex gap-2 min-[481px]:gap-3 flex-1 min-[481px]:flex-none min-[481px]:justify-end">
            <button
              onClick={onClose}
              className="flex-1 min-[481px]:flex-none px-4 py-3.5 min-[481px]:py-2 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl min-[481px]:rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 active:bg-gray-100 transition-colors text-sm min-[481px]:text-base font-medium"
            >
              {t('close')}
            </button>
            <button
              ...
              className="flex-1 min-[481px]:flex-none px-4 py-3.5 min-[481px]:py-2 text-white bg-[#476a30] hover:bg-[#3d5a28] active:bg-[#34501f] rounded-xl min-[481px]:rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm min-[481px]:text-base font-medium"
            >
